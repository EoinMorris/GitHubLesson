...
**Research location:** [TODO: Which three islands were the penguins observed on? Hint: check the `island` column in `data/penguins_raw.csv`] Torgersen, Biscoe, and Dream.

**Sample size:** [TODO: How many penguins are in the raw dataset? Hint: look at how the analysis script checks this] 344.

**Years of data collection:** [TODO: What years were data collected? Hint: check the `year` column in the CSV] 2007 - 2009
